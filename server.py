...
The application accepts a text input, sends it to the emotion detection
module, and returns the detected emotion scores together with the
dominant emotion.
"""
...
def emotion_analyzer():
    ...
    Retrieves the user's input from the request, passes it to the
    emotion detection function, and formats the results for display.
    """
...
def render_index_page():
    """Load the application's main page.

    Displays the interface where users can enter text and view the
